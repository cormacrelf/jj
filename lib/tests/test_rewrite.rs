...
fn test_rebase_descendants_basic_bookmark_update() {
    ...
    assert_eq!(
        tx.mut_repo().get_local_bookmark("main"),
...
fn test_rebase_descendants_basic_bookmark_update_with_non_local_bookmark() {
    ...
    assert_eq!(
        tx.mut_repo().get_remote_bookmark("main", "origin"),
        commit_b_remote_ref,
    );
    assert_eq!(
...
fn test_rebase_descendants_update_bookmarks_after_divergent_rewrite() {
    ...
    let main_target = tx.mut_repo().get_local_bookmark("main");
    ...
    let other_target = tx.mut_repo().get_local_bookmark("other");
...
fn test_rebase_descendants_rewrite_updates_bookmark_conflict() {
    ...
    tx.mut_repo().set_local_bookmark_target(
        "main",
    ...
    let target = tx.mut_repo().get_local_bookmark("main");
