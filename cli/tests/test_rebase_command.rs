...
fn test_rebase_invalid() {
    ...
    insta::assert_snapshot!(stderr, @r###"
    error: the argument '--bookmark <BOOKMARK>' cannot be used with '--source <SOURCE>'

    Usage: jj rebase --bookmark <BOOKMARK> <--destination <DESTINATION>|--insert-after <INSERT_AFTER>|--insert-before <INSERT_BEFORE>>
    ...
    insta::assert_snapshot!(stderr, @r###"
    error: the argument '--bookmark <BOOKMARK>' cannot be used with '--insert-after <INSERT_AFTER>'
    ...
    insta::assert_snapshot!(stderr, @r###"
    error: the argument '--bookmark <BOOKMARK>' cannot be used with '--insert-before <INSERT_BEFORE>'
